...
Le projet Unreal Engine vide est en place, essayez de nommer vos elements de la manière la plus clair possible avec notamment un préfixe définissant le type de l'élement (ex: M_ex si c'est un material) , nous travaillerons sur la version 5.4 (la même que celle installée dans l'IUT).
